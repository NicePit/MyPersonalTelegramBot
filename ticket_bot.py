...
class TicketFinder:
    ...
    @staticmethod
    def run(destination, min_days, max_days, target_month, departure_days):
        ...
        for i in range(0, 2):
            ...
            if destination_city:
                selenium_driver.find_element_by_css_selector("#destination.in-text.tt-query").send_keys(
                    destination_city)
                time.sleep(10)
...
cls = TicketFinder()
cls.run(destination=None, min_days=3, max_days=7, target_month=4, departure_days=[1])
